...
void HCNNG(std::string base_path, std::string query_path, std::string ground_path, unsigned K = 20) {
...
int main(int argc, char** argv) {
    ...
    HCNNG(absolute_path + base_path, absolute_path + query_path, absolute_path + ground_path, 100);
